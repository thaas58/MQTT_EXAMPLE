# Raspberry Pi Pico 2 W MQTT_EXAMPLE
MQTT Client Firmware Example Code for the Raspberry Pi Pico 2 W
...
I based this example code off of some code originally written by Dirk Ziegelmeier.  Since I couldn't really find any adequate example Pi Pico 2 W code that publishes data, I added code that publishes a heartbeat counter and AHT20 humidity/temperature readings to a Mosquitto MQTT server running on my Raspberry Pi 3B.  I verified the published data using the MQTT Explorer client.
